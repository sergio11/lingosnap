...
internal class CreateLingoSnapRemoteMapper: IBrownieOneSideMapper<CreateLingoSnapDTO, Map<String, Any?>> {
    ...
    override fun mapInToOut(input: CreateLingoSnapDTO): Map<String, Any?> = with(input) {
        hashMapOf(
            UID_KEY to uid,
    ...
    override fun mapInListToOutList(input: Iterable<CreateLingoSnapDTO>): Iterable<Map<String, Any?>> =
